...
for i = 1:num_cells
    ...
    figure(cell_id)
    subplot(2,4,1)
    plot(batch(i).summary.cycle, batch(i).summary.QDischarge, 'Color','r','LineWidth',1.5)%change to raw data
    hold on
    plot(batch(i).summary.cycle, batch(i).summary.QCharge, 'Color', 'b','LineWidth',1.5)
    hold on
    ...
    figure(cell_id)
    subplot(2,4,3)
    plot(batch(i).summary.cycle, batch(i).summary.Tmax, 'Color', [0.800000 0.250000 0.330000],'LineWidth',1.5)
    hold on
    plot(batch(i).summary.cycle, batch(i).summary.Tmin, 'Color', [0.600000 0.730000 0.890000],'LineWidth',1.5)
    hold on 
    plot(batch(i).summary.cycle, batch(i).summary.Tavg, 'Color',[1.000000 0.620000 0.000000],'LineWidth',1.5)
    xlabel('Cycle Index')
    ...
    figure(cell_id)
    subplot(2,4,2)
    plot(batch(i).summary.cycle,batch(i).summary.chargetime,'LineWidth',1.5)
    hold on 
    xlabel('Cycle Index')
